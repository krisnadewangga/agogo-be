...
@section('content')
	@component('components.card', ['title' => 'Lap. Total Tax Harian Web & Android', 
								   'breadcumbs' => array(
                                                          array('judul' => 'Lap. Tax','link' => '#')
                                                    	) 
                                  ])
        <div class="card">
        	<form method="POST" action="{{ route('cari_tax_harian_web') }}">
	        	@csrf
	        	<div class="row">
	        		<div class="col-md-3">
        		...
        		<div  style="margin-top: 5px;">
        			...
        			<a href="{{ route('lap_tax_harian_web') }}"><label class="btn btn-warning" >Reset</label></a>
        ...
        <script type="text/javascript">
        	...
        	function export_pdf()
        	{
				...
				window.open('export_tax_harian_web?mt='+tanggal+'&st='+tanggal1+'&sort_by='+sort_by+'&opsi_sort='+opsi_sort, '_blank');
        	}
        </script>
    @endcomponent
@endsection