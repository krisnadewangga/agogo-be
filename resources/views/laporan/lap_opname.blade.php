...
@section('content')
	@component('components.card', ['title' => 'Lap. Opname', 
        ...
        <div class="card">
        	<form method="POST" action="{{ route('cari_opname') }}">
	        	...
	        	<div style="margin-top: 5px;">
	        		...
	        		<a href="{{ route('set_tanggal') }}" onclick="return confirm('Apakah Anda Yakin Untuk Set Tanggal ?') "><label class="btn btn-danger" >Set Tanggal</label></a>
	        	</div>
        	</form>
        </div>
        ...
        <script type="text/javascript">
        	...
        	function export_pdf()
        	{
        		...
        		window.open('export_opname?tanggal='+kt, '_blank');
        	}
	...
	@component("components.modal", ["id" => "modal_set_tanggal" ,"kop_modal" => "Form Set Tanggal Produksi"])
		<form method="POST" action="{{ route('set_tanggal') }}" >
			@csrf
			...
			<div class="form-group  @error('tanggal') has-error @enderror">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" id="mt" class="form-control pull-right datepicker" name="tanggal" autocomplete="off" value="">
