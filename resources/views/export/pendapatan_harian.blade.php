    ...
    <table border="0">
        <tr>
            ...
            <td  style="width: 70%; text-align: right;">
                <h4 style="">LAPORAN TOTAL PENDAPATAN HARIAN</h4>
         ...
         <table class="layout display responsive-table">
            ...
            <tbody>
                ...
                @forelse($data['data'] as $key)
                     <tr>
                        ...
                        <td style="text-align:right;border-bottom:0px"> {{ number_format($key->transaksi) }}</td>
                        <td style="text-align:right;border-bottom:0px">{{ number_format($key->total_diskon) }}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th style="text-align:right;border-bottom:0px;border-top: 1px solid black;"> {{ $data['grandTotalTransaksi'] }}</th>
                    <th style="text-align:right;border-bottom:0px;border-top: 1px solid black;"> {{ $data['grandTotalDiskon'] }}</th>
