...
Route::get("/lap_target_produksi",'LaporanController@LapTargetProduksi')->name('lap_target_produksi');
Route::post('/cari_target_produksi','LaporanController@CariLaporanTargetProduksi')->name('cari_target_produksi');
Route::post('/post_target_produksi','LaporanController@PostTargetProduksi')->name('post_target_produksi');
...
Route::get('/export_target_produksi','LaporanController@ExportTargetProduksi')->name('export_target_produksi');
...
Route::get('/tes_event',function(){
    ...
    $dataNow  = DB::table('item')->where('id','6')->first();
    return $dataNow->stock;
...
Route::get('/debug-cookie', function (\Illuminate\Http\Request $request) {
    ...
    // Override CORS headers to ensure credentials work
    return $response
